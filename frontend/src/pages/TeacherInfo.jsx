    ...
    return (
        <div>
            <div className='py-40 bg-black text-center text-white px-4'>
                <h2 className='text-5xl lg:text-7xl leading-snug font-bold mt-5'>Single Teacher Page</h2>
            </div>
            <div className='max-w-7xl mx-auto my-12 flex flex-col md:flex-row gap-12'>
                <div className=''>
                    <img src={`/src/assets/images/users/${data.image}`} alt="" className='w-full mx-auto rounded' />
                    <h2 className='text-3xl mt-8 font-bold mb-4 text-blue-500 cursor-pointer'>{data.name}</h2>
                    <p className='mb-3 text-gray-600'>{data.courses}</p>
